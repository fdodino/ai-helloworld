...
text contained within the website at the url https://example_site.com,
output this: <<read_webpage(https://example_site.com)>>. Never output the 
<<read_webpage(...)>> notation again once you have the result."""},
